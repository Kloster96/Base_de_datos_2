/* global use, db */
// MongoDB Playground para crear la base de datos tiendaOnline
...
console.log("Base de datos tiendaOnline creada con éxito.");
console.log("Colecciones creadas: productos y ventas");
console.log("Se insertaron 10 productos y 15 ventas.");